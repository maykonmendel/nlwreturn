        ...
        <>
            ...
            <div className="flex flex-col items-center py-10 w-[304px]">
                ...
                <button
                    ...
                    hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-500 disabled:opacity-50 
