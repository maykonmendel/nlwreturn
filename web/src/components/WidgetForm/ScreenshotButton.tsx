...
export function ScreenshotButton({ screenshot, onScreenshotTook } : ScreenButtonProps) {
    ...
    if (screenshot) {
        return (
            <button
                type="button"
                className="p-1 w-10 h-1o rounded-md border-transparent flex justify-end items-end
